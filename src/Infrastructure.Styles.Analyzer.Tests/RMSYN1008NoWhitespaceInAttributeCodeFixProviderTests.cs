...
{
  public class RMSYN1008NoWhitespaceInAttributeCodeFixProviderTests
  {
    private static readonly RMSYN1008NoWhitespaceInAttributeAnalyzer Analyzer = new();
    private static readonly RMSYN1008NoWhitespaceInAttributeCodeFixProvider CodeFixProvider = new();
